...
{
    [AutoloadHead]
    public class SlayerMasterTurael : ModNPC
    {
        public override string Texture
        {
            get
            {
                return "OldSchoolRuneScape/NPCs/Slayer_Turael";
            }
        }
        ...
        public override string GetChat()
        {
            ...
            if (player.GetModPlayer<OSRSplayer>().slayTasksComplete >= 10 && OSRSworld.slayBossProgress < 1)
            {
        ...
        {
            return OSRSworld.slayBossProgress == 0;
        }
