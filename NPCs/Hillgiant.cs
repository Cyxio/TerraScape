...
namespace OldSchoolRuneScape.NPCs
{
    public class Hillgiant : ModNPC
    {
        ...
        public override void NPCLoot()
        {
            ...
            int item = mod.ItemType<Items.Magic.Airrune>();
            int stack = Main.rand.Next(5, 11);
            switch (ch)
            {
                case 0:
                    item = mod.ItemType<Items.Magic.Lawrune>();
                    stack = 2;
                    break;
                case 1:
                    item = mod.ItemType<Items.Magic.Waterrune>();
                    break;
                case 2:
                    item = mod.ItemType<Items.Magic.Earthrune>();
                    break;
                case 3:
                    item = mod.ItemType<Items.Magic.Firerune>();
                    break;
                case 4:
                    item = mod.ItemType<Items.Magic.Mindrune>();
                    break;
                case 5:
                    item = mod.ItemType<Items.Magic.Cosmicrune>();
                    stack = 2;
                    break;
                default:
            ...
            {
                Item.NewItem(npc.Hitbox, mod.ItemType<Items.Longbone>());
            }
        }
