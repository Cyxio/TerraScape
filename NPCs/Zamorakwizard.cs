...
namespace OldSchoolRuneScape.NPCs
{
    public class Zamorakwizard : ModNPC
    {
        ...
        public override void NPCLoot()
        {
            ...
            {
                Item.NewItem(npc.Hitbox, ModContent.ItemType<Items.Magic.Zamorakstaff>());
            }
        }
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            else
            {
                ...
                Gore.NewGore(npc.Center, new Vector2(Main.rand.NextFloat(-1f, 1f), Main.rand.NextFloat(-1f, 1f)), mod.GetGoreSlot("Gores/Zamorakwizard1"), 1f);
                Gore.NewGore(npc.Center, new Vector2(Main.rand.NextFloat(-1f, 1f), Main.rand.NextFloat(-1f, 1f)), mod.GetGoreSlot("Gores/Zamorakwizard1"), 1f);
            }
        ...
        public override void AI()
        {
            ...
            else if (npc.ai[0] == 3)
            {
                ...
                if (npc.ai[1] == 30 && Main.netMode != 1)
                {
                    ...
                    spd.Normalize();
                    spd *= 14;
                    Projectile.NewProjectile(npc.Center, spd, 258, npc.damage / 4, 0f);
                }
                if (npc.ai[1] > 40)
                {
                    npc.ai[1] = 0;
