...
namespace OldSchoolRuneScape.Items.ClueScroll.ClueRewards.ForAll
{
    ...
    public class Bookwar : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(mod.ItemType<Bandospage1>());
            r.AddIngredient(mod.ItemType<Bandospage2>());
            r.AddIngredient(mod.ItemType<Bandospage3>());
            r.AddIngredient(mod.ItemType<Bandospage4>());
