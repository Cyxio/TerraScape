...
namespace OldSchoolRuneScape.NPCs
{
    public class Guthixwizard : ModNPC
    {
        ...
        public override void NPCLoot()
        {
            ...
            {
                Item.NewItem(npc.Hitbox, ModContent.ItemType<Items.Magic.Guthixstaff>());
            }
        }
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            else
            {
                ...
                Gore.NewGore(npc.Center, new Vector2(Main.rand.NextFloat(-1f, 1f), Main.rand.NextFloat(-1f, 1f)), mod.GetGoreSlot("Gores/Guthixwizard1"), 1f);
                Gore.NewGore(npc.Center, new Vector2(Main.rand.NextFloat(-1f, 1f), Main.rand.NextFloat(-1f, 1f)), mod.GetGoreSlot("Gores/Guthixwizard1"), 1f);
            }
        ...
        public override void AI()
        {
            ...
            else if (npc.ai[0] == 3)
            {
                ...
                if (npc.ai[1] == 30)
                {
                    ...
                    spd.Normalize();
                    spd *= 14;
                    int proj = Projectile.NewProjectile(npc.Center, spd, 604, npc.damage / 4, 0f);
