...
namespace OldSchoolRuneScape.NPCs
{
    ...
    public class SlayerMasterVannaka : ModNPC
    {
        public override string Texture
        {
            get
            {
                return "OldSchoolRuneScape/NPCs/Slayer_Vannaka";
            }
        }
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            if (npc.life <= 0)
            {
                Gore.NewGore(npc.position, npc.velocity * Main.rand.NextFloat(0.9f, 1.1f), mod.GetGoreSlot("Gores/Vannaka1"), npc.scale);
                Gore.NewGore(npc.position, npc.velocity * Main.rand.NextFloat(0.9f, 1.1f), mod.GetGoreSlot("Gores/Vannaka2"), npc.scale);
                Gore.NewGore(npc.position, npc.velocity * Main.rand.NextFloat(0.9f, 1.1f), mod.GetGoreSlot("Gores/Vannaka2"), npc.scale);
                Gore.NewGore(npc.position, npc.velocity * Main.rand.NextFloat(0.9f, 1.1f), mod.GetGoreSlot("Gores/Vannaka3"), npc.scale);
            }
        }
        ...
        {
            item = mod.GetTexture("NPCs/VannakaSword");
            scale = 1f;
            itemSize = 54;
