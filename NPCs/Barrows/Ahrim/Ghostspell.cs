    ...
    public class Ghostspell : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[0] == 1)
            {
                ...
                {
                    Projectile.NewProjectile(projectile.Center, projectile.velocity.RotatedBy(MathHelper.ToRadians(90)) * 1.5f, mod.ProjectileType<Ghostspell>(), projectile.damage, 0f, 0, 99, 0);
                    Projectile.NewProjectile(projectile.Center, projectile.velocity.RotatedBy(MathHelper.ToRadians(-90)) * 1.5f, mod.ProjectileType<Ghostspell>(), projectile.damage, 0f, 0, 99, 0);
                    projectile.Kill();
                }
            }
