...
namespace OldSchoolRuneScape.NPCs.Barrows.Dharok
{
    public class Dharokbag : ModItem
    {
        ...
        public override int BossBagNPC => mod.NPCType("Dharok");
        ...
        public override void OpenBossBag(Player player)
        {
            ...
            int helm = ModContent.ItemType<Items.Armor.Dharokhelm>();
            int body = ModContent.ItemType<Items.Armor.Dharokbody>();
            int legs = ModContent.ItemType<Items.Armor.Dharoklegs>();
            int wep = ModContent.ItemType<Items.Dharokaxe>();
            int drop = 0;
            for (int i = 0; i < 200; i++)
            {
                bool allcheck = false;
            ...
            {
                player.QuickSpawnItem(ModContent.ItemType<Items.Rockcake>());
            }
        }
    }
    [AutoloadBossHead]
    public class Dharok : ModNPC
    {
        ...
        public override void NPCLoot()
        {
            ...
            Item.NewItem(npc.Hitbox, ModContent.ItemType<Dharoksummon>());
            if (Main.expertMode)
            {
                npc.DropBossBags();
            }
            else
            {
                ...
                {
                    case 0:
                        drop = ModContent.ItemType<Items.Dharokaxe>();
                        break;
                    case 1:
                        drop = ModContent.ItemType<Items.Armor.Dharokhelm>();
                        break;
                    case 2:
                        drop = ModContent.ItemType<Items.Armor.Dharokbody>();
                        break;
                    case 3:
                        drop = ModContent.ItemType<Items.Armor.Dharoklegs>();
                        break;
                    default:
                        break;
                }
                ...
                {
                    Item.NewItem(npc.Hitbox, ModContent.ItemType<Items.Rockcake>());
                }
            }
        }
