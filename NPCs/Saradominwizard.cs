...
namespace OldSchoolRuneScape.NPCs
{
    public class Saradominwizard : ModNPC
    {
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.Magic.Sarastaff>(), 33));
        }
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            else
            {
                ...
                Gore.NewGore(NPC.GetSource_Death(), NPC.Center, new Vector2(Main.rand.NextFloat(-1f, 1f), Main.rand.NextFloat(-1f, 1f)), Mod.Find<ModGore>("Saradominwizard1").Type, 1f);
                Gore.NewGore(NPC.GetSource_Death(), NPC.Center, new Vector2(Main.rand.NextFloat(-1f, 1f), Main.rand.NextFloat(-1f, 1f)), Mod.Find<ModGore>("Saradominwizard1").Type, 1f);
            }
        ...
        public override void AI()
        {
            ...
            else if (NPC.ai[0] == 3)
            {
                ...
                if (NPC.ai[1] == 30)
                {
                    ...
                    spd.Normalize();
                    spd *= 14;
                    int proj = Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, spd, ProjectileID.DiamondBolt, NPC.damage / 4, 0f);
