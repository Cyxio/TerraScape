...
namespace OldSchoolRuneScape.NPCs
{
    ...
    public class SlayerMasterMazchna : ModNPC
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Mazchna1").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Mazchna2").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Mazchna2").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Mazchna3").Type, NPC.scale);
            }
        }
        ...
        {
            return new List<string> { "Mazchna" };
        }
        ...
        {
            item = ModContent.Request<Texture2D>("NPCs/MazchnaSword").Value;
            scale = 1f;
            itemSize = 54;
