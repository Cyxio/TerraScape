...
namespace OldSchoolRuneScape.NPCs
{
    public class Blackdragon : ModNPC
    {
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.Blackdhide>(), 1, 3, 6));
        }
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Blackdragon").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Blackdragon1").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Blackdragon1").Type, NPC.scale);
            }
        }
            ...
            { 
                ...
                if (attack == 0)
                {
                    ...
                    if(AI_Timer % 6 == 0)
                    {
                        ...
                        Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center + rotates, spd, Mod.Find<ModProjectile>("Dragonfire").Type, (NPC.damage / 4), 0f, 0, 1, 0);
                    }
                    if (AI_Timer > 20)
                    {
                        AI_State = Fly;
