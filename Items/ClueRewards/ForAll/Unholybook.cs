...
namespace OldSchoolRuneScape.Items.ClueScroll.ClueRewards.ForAll
{
    ...
    public class Unholybook : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(mod.ItemType<Zamorakpage1>());
            r.AddIngredient(mod.ItemType<Zamorakpage2>());
            r.AddIngredient(mod.ItemType<Zamorakpage3>());
            r.AddIngredient(mod.ItemType<Zamorakpage4>());
