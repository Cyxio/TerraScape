...
{
    public class WaterwaveP : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Waterwave");
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft % 5 == 0)
            {
                ...
                for (int i = 0; i < 18; i++)
                {
                    ...
                    speed.Normalize();
                    dust = Terraria.Dust.NewDustPerfect(spawn, 263, speed, 0, c, 1f);
                    dust.noGravity = true;
            ...
            if (Projectile.timeLeft < 19)
            {
                if (Projectile.alpha != 255)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("OldSchoolRuneScape/Sounds/Item/Waterhit4"), Projectile.position);
                }
        ...
        public override void PostDraw(Color lightColor)
        {
            if (Projectile.timeLeft < 18)
            {
                ...
                Main.EntitySpriteDraw(ModContent.Request<Texture2D>("Projectiles/WaveExplode3").Value, Projectile.position - Main.screenPosition, new Rectangle(0, 112 * frame, 112, 112), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0);
            }
        }
