...
namespace OldSchoolRuneScape.NPCs
{
    public class Smokedevil : ModNPC
    {
        ...
        public override void NPCLoot()
        {
            ...
            {
                Item.NewItem(npc.Hitbox, mod.ItemType<Items.Magic.Smokebattlestaff>());
            }
        }
        public override void AI()
        {
            ...
            if (npc.ai[3] > 30 && Main.netMode != 1)
            {
                ...
                spd.Normalize();
                spd *= 14;
                Projectile.NewProjectile(npc.Center, spd, mod.ProjectileType<Projectiles.Smokedevil>(), npc.damage / 4, 0f);
                npc.ai[3] = 0;
                npc.netUpdate = true;
            }
        }
