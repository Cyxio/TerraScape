    ...
    public class FirewaveP : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft < 19)
            {
                if (Projectile.alpha != 255)
                {
                    ...
                    SoundEngine.PlaySound(new SoundStyle("OldSchoolRuneScape/Sounds/Item/Firehit4"), Projectile.position);
                }
        ...
        public override void PostDraw(Color lightColor)
        {
            if (Projectile.timeLeft < 18)
            {
                ...
                Main.EntitySpriteDraw(ModContent.Request<Texture2D>("Projectiles/WaveExplode2").Value, Projectile.position - Main.screenPosition, new Rectangle(0, 112 * frame, 112, 112), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0);
            }
        }
