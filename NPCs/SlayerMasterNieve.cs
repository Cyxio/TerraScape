...
namespace OldSchoolRuneScape.NPCs
{
    ...
    public class SlayerMasterNieve : ModNPC
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Nieve1").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Nieve2").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Nieve2").Type, NPC.scale);
                Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * Main.rand.NextFloat(0.9f, 1.1f), Mod.Find<ModGore>("Nieve3").Type, NPC.scale);
            }
        }
        ...
        {
            item = ModContent.Request<Texture2D>("NPCs/NieveHasta").Value;
            scale = 1f;
            itemSize = 54;
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)
        {
            ...
            shop.item[nextSlot].shopSpecialCurrency = OldSchoolRuneScape.SlayerTokenCurrencyInt;
            nextSlot++;
            shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Weapons.Melee.Sarasword>());
            shop.item[nextSlot].shopCustomPrice = new int?(500);
            shop.item[nextSlot].shopSpecialCurrency = OldSchoolRuneScape.SlayerTokenCurrencyInt;
            nextSlot++;
            shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Weapons.Melee.AGS>());
            shop.item[nextSlot].shopCustomPrice = new int?(999);
            shop.item[nextSlot].shopSpecialCurrency = OldSchoolRuneScape.SlayerTokenCurrencyInt;
            nextSlot++;
            shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Weapons.Melee.BGS>());
            shop.item[nextSlot].shopCustomPrice = new int?(999);
            shop.item[nextSlot].shopSpecialCurrency = OldSchoolRuneScape.SlayerTokenCurrencyInt;
            nextSlot++;
            shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Weapons.Melee.SGS>());
            shop.item[nextSlot].shopCustomPrice = new int?(999);
            shop.item[nextSlot].shopSpecialCurrency = OldSchoolRuneScape.SlayerTokenCurrencyInt;
            nextSlot++;
            shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.Weapons.Melee.ZGS>());
            shop.item[nextSlot].shopCustomPrice = new int?(999);
            shop.item[nextSlot].shopSpecialCurrency = OldSchoolRuneScape.SlayerTokenCurrencyInt;
            nextSlot++;
            for (int i = 0; i < 255; i++)
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            c.A = (byte)(200 + f);
            spriteBatch.Draw(ModContent.Request<Texture2D>("NPCs/ElysianShield").Value, NPC.position + new Vector2(-11, -12) - Main.screenPosition, NPC.frame, c, 0f, Vector2.Zero, 1f, s, 0f);
        }
    }
}