...
namespace OldSchoolRuneScape.NPCs.Barrows.Guthan
{
    public class Guthanbag : ModItem
    {
        ...
        public override void OpenBossBag(Player player)
        {
            ...
            int helm = mod.ItemType<Items.Armor.Guthanhelm>();
            int body = mod.ItemType<Items.Armor.Guthanbody>();
            int legs = mod.ItemType<Items.Armor.Guthanlegs>();
            int wep = mod.ItemType<Items.Guthanspear>();
            int drop = 0;
            for (int i = 0; i < 200; i++)
            {
                bool allcheck = false;
    ...
    public class Guthan : ModNPC
    {
        ...
        {
            Item.NewItem(npc.Hitbox, mod.ItemType<Guthansummon>());
            if (Main.expertMode)
            {
                npc.DropBossBags();
            }
            else
            {
                ...
                {
                    case 0:
                        drop = mod.ItemType<Items.Guthanspear>();
                        break;
                    case 1:
                        drop = mod.ItemType<Items.Armor.Guthanhelm>();
                        break;
                    case 2:
                        drop = mod.ItemType<Items.Armor.Guthanbody>();
                        break;
                    case 3:
                        drop = mod.ItemType<Items.Armor.Guthanlegs>();
                        break;
                    default:
                        break;
                }
