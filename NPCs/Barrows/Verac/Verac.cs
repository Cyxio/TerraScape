...
namespace OldSchoolRuneScape.NPCs.Barrows.Verac
{
    public class Veracbag : ModItem
    {
        ...
        {
            int helm = mod.ItemType<Items.Armor.Verachelm>();
            int body = mod.ItemType<Items.Armor.Veracbody>();
            int legs = mod.ItemType<Items.Armor.Veraclegs>();
            int wep = mod.ItemType<Items.Veracflail>();
            int drop = 0;
            for (int i = 0; i < 200; i++)
            {
                bool allcheck = false;
    ...
    public class Verac : ModNPC
    {
        ...
        {
            Item.NewItem(npc.Hitbox, mod.ItemType<Veracsummon>());
            if (Main.expertMode)
            {
                npc.DropBossBags();
            }
            else
            {
                ...
                {
                    case 0:
                        drop = mod.ItemType<Items.Veracflail>();
                        break;
                    case 1:
                        drop = mod.ItemType<Items.Armor.Verachelm>();
                        break;
                    case 2:
                        drop = mod.ItemType<Items.Armor.Veracbody>();
                        break;
                    case 3:
                        drop = mod.ItemType<Items.Armor.Veraclegs>();
                        break;
                    default:
                        break;
                }
