...
{
    public class Varrockteleport : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Varrock Teleport");
            Tooltip.SetDefault("Teleports you to a sky island\n-Not Working in Multiplayer-");
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "Firerune", 1);
        ...
        public override void UseStyle(Player player)
        {
            ...
            if (player.itemAnimation == player.itemAnimationMax - 1)
            {
                for (int y = 0; y < Main.maxTilesY / 3; y++)
                {
                    ...
                    {
                        if (Main.tile[x, y].type == TileID.RainCloud)
                        {
